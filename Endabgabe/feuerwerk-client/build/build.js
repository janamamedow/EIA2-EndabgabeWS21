...
(function (firework) {
    ...
    firework.herokuUrl = "https://janaeia2.herokuapp.com/";
})(firework || (firework = {}));
var firework;
(function (firework) {
...
(function (firework) {
    ...
    function onPageLoad() {
        ...
        if (!firework.canvas)
            return;
        //add click events
        firework.canvas.addEventListener("mousedown", startRakete);
    ...
    function gameLoop() {
        ...
        for (var i = 0; i < rockets.length; i++) {
            ...
            if (rockets[i].pos.y < firework.canvas.height * 0.2) {
                firework.allScatters.push(...rockets[i].startRakete());
